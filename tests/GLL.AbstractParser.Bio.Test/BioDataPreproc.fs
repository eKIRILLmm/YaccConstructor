...
let writeAllTriples basePath (sw:StreamWriter) =
    ...
    writeTriplesFromEntrezGene (basePath + "\map\UniprotToEntrezGene.txt") (System.IO.Directory.GetFiles(basePath + "\Entrez Gene")) sw
    ...
    writeTriplesFromGO (basePath + "\map\UniprotToGO.txt") (basePath + "\Gene Ontology\go.owl") sw
